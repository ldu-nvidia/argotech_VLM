...
class AgroVLMAgent:
    def __init__(self) -> None:
        ...
        self.prompts = ["can you tell what plant is this from the leaf?", "is the leaf healthy or not?", "what kind of disease do you think the leaf has?"]
...
def main():
    ...
    one_image = vlm_agent.image_directory + os.listdir(vlm_agent.image_directory)[0]
